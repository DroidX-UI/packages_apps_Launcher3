...
public class DroidXLauncherModelDelegate extends QuickstepModelDelegate
    implements SmartspaceSession.OnTargetsAvailableListener {

    public static final String TAG = "DroidXLauncherModelDelegate";
    ...
    public DroidXLauncherModelDelegate(Context context) {
        super(context);
        mContext = context;
    }
