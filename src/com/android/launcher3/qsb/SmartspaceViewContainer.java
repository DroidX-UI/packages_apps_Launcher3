...
import com.droidx.launcher.DroidXLauncher;
import com.droidx.launcher.DroidXLauncherModelDelegate;
...
public class SmartspaceViewContainer extends FrameLayout implements PluginListener<BcSmartspaceDataPlugin> {
    ...
    public SmartspaceViewContainer(Context context, AttributeSet attributeSet) {
        ...
        DroidXLauncher launcher = (DroidXLauncher) ActivityContext.lookupContext(context);
        launcher.getLauncherUnlockAnimationController().setSmartspaceView(mView);

        DroidXLauncherModelDelegate delegate = (DroidXLauncherModelDelegate) launcher.getModel().getModelDelegate();
    ...
    public void onPluginDisconnected(BcSmartspaceDataPlugin plugin) {
        DroidXLauncher launcher = (DroidXLauncher) ActivityContext.lookupContext(getContext());
